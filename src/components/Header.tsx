      ...
      <div className="flex items-center space-x-2">
        ...
        {onAdminClick && (
          <button
            ...
            className="p-2 bg-gradient-to-tr from-pink-500/20 to-purple-500/20 hover:from-pink-500/30 hover:to-purple-500/30 text-pink-400 rounded-full transition-all border border-pink-500/40 relative group"
            title="Open Admin Control Center"
          >
            <ShieldAlert className="w-4 h-4" />
            <span className="absolute -bottom-7 left-1/2 -translate-x-1/2 px-1.5 py-0.5 bg-black/90 text-[9px] font-bold text-pink-300 rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none">
              Admin
            </span>
          </button>
        )}
