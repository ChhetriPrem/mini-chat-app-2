...
export const LiveStreamView: React.FC<LiveStreamViewProps> = ({
  ...
  const [activeGame, setActiveGame] = useState<'spin' | null>(null);
      ...
      {activeGame === 'spin' && (
        <div className="fixed inset-0 z-40 flex items-center justify-center p-3 bg-black/60 backdrop-blur-sm pointer-events-auto">
          <div className="w-full max-w-sm animate-in zoom-in-95 duration-200">
            <SpinWheelGame onClose={() => setActiveGame(null)} />
          </div>
        </div>
      )}
        ...
        <div className="flex items-center justify-between pt-1.5 border-t border-white/10">
          ...
          <div className="flex items-center space-x-1.5">
            ...
            <div className="relative">
              ...
              {isGamePickerOpen && (
                <div className="absolute bottom-full left-0 mb-2 w-48 bg-black/95 border border-white/20 backdrop-blur-xl rounded-2xl p-2 shadow-2xl flex flex-col space-y-1.5 z-40">
